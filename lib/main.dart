    ...
    child:  Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
            image: AssetImage("assets/img/spaceship.png"),
            fit: BoxFit.cover
        ),
      ),
    ),
  ...
  Widget e = Container(
    ...
    child:  Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(50.0),
        image: DecorationImage(
            image: AssetImage("assets/img/thanos.png"),
            fit: BoxFit.cover
        ),
      ),
    ),
...
//                    Icon(Icons.airplanemode_active,color: Colors.red,size: 320,),
                      Padding(
                        ...
                        child: Text(
                          "Space war",
                          style: TextStyle(color: Colors.blue, fontSize: 42,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),
                        ),
                      ),
                      Text(
                        "Score: ${c - 1}",
                        style: TextStyle(color: Colors.grey, fontSize: 62,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),
                      ),
                      GestureDetector(
                        onTap: () {
                          id();
                          ...
                          return Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(50.0),
                                image: DecorationImage(
                                    image: AssetImage("assets/img/ironman.png"),
                                    fit: BoxFit.cover
                                ),
                              ),
                            ),
